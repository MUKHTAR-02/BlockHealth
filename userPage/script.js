...
Shery.imageEffect("#imgtext img", {
  style: 6,
  config: {
    noiseDetail: { value: 12.4, range: [0, 100] },
    distortionAmount: { value: 1.24, range: [0, 10] },
...
Shery.imageEffect("#firstpic img", {
  ...
  config: {
    ...
    modeA: { value: 1 },
    modeN: { value: 1 },
    speed: { value: -1.89, range: [-500, 500], rangep: [-10, 10] },
    ...
    zindex: { value: -9996999, range: [-9999999, 9999999] },
    aspect: { value: 0.7082917162898766 },
    gooey: { value: false },
    infiniteGooey: { value: false },
    growSize: { value: 4, range: [1, 15] },
    durationOut: { value: 1, range: [0.1, 5] },
...
Shery.imageEffect("#firstpic2 img", {
  style: 2,
  config: {
    resolutionXY: { value: 100 },
    distortion: { value: true },
